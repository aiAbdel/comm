...
namespace Your.Feature.Payments.Controllers.Api
{
  public class WebhooksController : Controller
  {
    ...
    private async Task HandleEvent(JObject ev)
    {
      ...
      if (!string.IsNullOrEmpty(subNumber) && (type.Equals("payment.processed", StringComparison.OrdinalIgnoreCase) || type.Equals("subscription.activated", StringComparison.OrdinalIgnoreCase)))
      { await _prov.GrantAccessAsync(accountNumber, subNumber); }
